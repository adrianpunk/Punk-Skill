...
| --- | --- | --- | --- | --- | --- | --- |
| `screenshots/` (all 38 example images) | Created by Licensor Adrian Punk using OpenAI ChatGPT Image 2.0 | [OpenAI Terms of Use](https://openai.com/policies/terms-of-use/) | Licensor-created outputs, subject to the provider terms applicable on the generation date and any rights in the inputs | Yes, subject to provider terms and input or third-party rights | Licensor's private ChatGPT generation/account records and declaration dated 2026-09-09 | Declared; generation evidence must be archived before `v2.0.0` |
